export type DateRangeKey = "28d" | "3m" | "6m" | "12m" | "all" | "all_time" | "current_month" | "previous_month" | "last_3_months" | "custom";
...
export function getDateRange(params?: { range?: string | null; startDate?: string | null; endDate?: string | null }): DateRange {
  ...
  if (key === "all" || key === "all_time") return { startDate: process.env.ALL_TIME_START_DATE || "2024-01-01", endDate: iso(end), label: "All time" };
