...
import { adjustedProjectFromRows, getProjectKpiSettings, projectKpiTypes } from "../../../lib/project-kpi";
...
export default async function ProjectKpiSettingsPage() {
  ...
  const [settings, rows] = await Promise.all([getProjectKpiSettings(), getDbPerformance("current_month", getDateRange({ range: "current_month" }))]);
