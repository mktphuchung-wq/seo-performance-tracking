...
import { DateRangePicker, fmtGrowth, fmtNum, fmtPct, fmtPos, MetricCard, MetricSection, Shell, StatusBadge, UrlTable, WarningList, type MetricTone } from "../../../components/ui";
...
export default async function AdminDashboard({ searchParams }: { searchParams?: { range?: string; startDate?: string; endDate?: string; sort?: import("../../../components/ui").UrlSortKey; direction?: import("../../../components/ui").UrlSortDirection; refreshError?: string } }) {
  ...
  <Diagnostics diagnostics={diagnostics} /><h3 className="mb-3 mt-8 text-xl font-semibold">SEO Team Performance</h3><div className="grid gap-6 lg:grid-cols-2"><MemberIndexSection title={`SEO Team Performance Tháng ${selectedRangeLabel}`} members={members} mode="quantity" /><MemberIndexSection title="SEO Performance Growth" members={members} mode="quality" /></div>
