...
create table public.member_performance_cache (
  ...
  performance_kpi_pct numeric,
  impression_performance_score numeric,
  click_performance_score numeric,
  growth_coverage_score numeric,
  portfolio_health_score numeric,
  eligible_url_count integer,
  excluded_no_data_url_count integer,
  positive_url_count integer,
  new_growth_url_count integer,
  declining_url_count integer,
  performance_kpi_status text,
